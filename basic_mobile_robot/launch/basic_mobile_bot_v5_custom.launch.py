...
def generate_launch_description():
  ...
  robot_localization_file_path = os.path.join(pkg_share, 'config/ekf_v2.yaml') 
  ...
  nav2_params_path = os.path.join(pkg_share, 'params', 'nav2_params_galactic.yaml')
  ...
  start_example_node_cmd = Node(
    package='my_package',
    executable='simple_pubsub',
    output='screen')

  example_launch_dir = os.path.join(FindPackageShare(package='my_package').find('my_package') , 'launch') 
  start_example_launch_cmd = IncludeLaunchDescription(
    PythonLaunchDescriptionSource(
      os.path.join(example_launch_dir, 'test.launch.py')
    )
  )
  ...
  ld.add_action(start_example_launch_cmd)
