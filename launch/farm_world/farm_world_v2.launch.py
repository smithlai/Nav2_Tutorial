...
#              This node uses the static transform publisher to publish the transform between map and odom.
...
def generate_launch_description():
  ...
  map_file_path = 'maps/farm_world/farm_world.yaml'
  nav2_params_path = 'params/farm_world/nav2_params_static_transform_pub.yaml'
  robot_localization_file_path = 'config/ekf_car_world.yaml'
  rviz_config_file_path = 'rviz/farm_world/nav2_config.rviz'
  sdf_model_path = 'models/two_wheeled_robot_description/model.sdf'
  urdf_file_path = 'models/two_wheeled_robot_v1.urdf'
