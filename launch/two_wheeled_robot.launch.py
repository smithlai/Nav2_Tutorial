...
def generate_launch_description():
  ...
  default_rviz_config_path = os.path.join(pkg_share, 'rviz/two_wheeled_robot_v1.rviz')
 
  # Set the path to the URDF file
  default_urdf_model_path = os.path.join(pkg_share, 'models/two_wheeled_robot_v1.urdf')
