...
def generate_launch_description():
  ...
  default_model_path = os.path.join(pkg_share, 'models/basic_mobile_bot_v1/basic_mobile_bot_v1.urdf')
  robot_localization_file_path = os.path.join(pkg_share, 'config/ekf.yaml') 
  robot_name_in_urdf = 'basic_mobile_bot'
  default_rviz_config_path = os.path.join(pkg_share, 'rviz/basic_mobile_bot_v1/urdf_config.rviz')
